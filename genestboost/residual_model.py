"""Residual model meta-class implementation."""
...
#
# from abc import ABC
# from . import BoostedLinearModel, BoostedModel
#
# class ResidualModelBase(ABC):
#     def boost(
#             self,
#             X: np.ndarray,
#             yt: np.ndarray,
...
# def residual_model(cls):
#     if isinstance(cls, BoostedLinearModel):
#         return ResidualModel()
#
# class ResidualModel(type):
#     """Residual model meta-class implementation."""
#
#     def __new__(cls, boosting_type="general"):
#         if type == "general":
#             pass
#         pass
#
